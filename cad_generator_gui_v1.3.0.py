...
class CADGeneratorApp:
    ...
    def _load_help_content(self, tab_id, text_widget):
        ...
        if tab_id == "overview":
            ...
            text_widget.insert("end", "\nCurrent Library: 25,000+ Configurations\n", "heading2")
            
            text_widget.insert("end", "\n1. Flanges (API 6A/6BX & ASME B16.5)\n", "emphasis")
            text_widget.insert("end", "   • Types: Weld Neck, Blind, Slip-On, Socket Weld, Threaded, Lap Joint\n")
            text_widget.insert("end", "   • Sizes: 1/2\" to 24\" (fractional supported)\n")
            text_widget.insert("end", "   • Pressure: 150# to 2500# (ASME), 2K-20K PSI (API)\n")
            text_widget.insert("end", "   • Ring Joint (RTJ) configurations included\n")
            text_widget.insert("end", "   • Count: ~650 configurations\n\n")
            ...
            text_widget.insert("end", "   • Elbows: 90° and 45° (LR and SR)\n")
            text_widget.insert("end", "   • 180° Returns: Long and Short Radius\n")
            text_widget.insert("end", "   • Tees: Equal and Reducing\n")
            text_widget.insert("end", "   • Reducers: Concentric and Eccentric\n")
            text_widget.insert("end", "   • Crosses, Pipes (plain and beveled ends)\n")
            text_widget.insert("end", "   • Sizes: 1/2\" to 24\" NPS\n")
            text_widget.insert("end", "   • Schedules: 5, 10, 20, 40, 80, 120, 160, XXS\n")
            text_widget.insert("end", "   • Count: 2,000+ configurations\n\n")
            ...
            text_widget.insert("end", "   • Custom ID, wall thickness, length\n\n")
            
            text_widget.insert("end", "6. Steel Shapes (AISC Database)\n", "emphasis")
            text_widget.insert("end", "   • W-Beams (Wide Flange): W4x13 to W44x335\n")
            text_widget.insert("end", "   • HSS Round: 1.660\" to 20\" OD\n")
            text_widget.insert("end", "   • HSS Square/Rectangular: 2x2 to 20x12\n")
            text_widget.insert("end", "   • Channels (C), Angles (L), Pipes\n")
            text_widget.insert("end", "   • Custom lengths supported\n")
            text_widget.insert("end", "   • Count: 2,301 shapes\n\n")
            
            text_widget.insert("end", "7. Wood Products\n", "emphasis")
            text_widget.insert("end", "   Dimensional Lumber:\n", "emphasis")
            text_widget.insert("end", "   • 2x4 through 2x12, 4x4 through 12x12\n")
            text_widget.insert("end", "   • Species: SPF, DF, SYP, Hem-Fir\n")
            text_widget.insert("end", "   • Custom lengths: 8' to 24'\n")
            text_widget.insert("end", "   Engineered Wood:\n", "emphasis")
            text_widget.insert("end", "   • LVL (Laminated Veneer Lumber)\n")
            text_widget.insert("end", "   • Glulam Beams\n")
            text_widget.insert("end", "   • PSL (Parallel Strand Lumber)\n")
            text_widget.insert("end", "   • TJI/I-Joists\n")
            text_widget.insert("end", "   • Count: 500+ configurations\n\n")
            
            text_widget.insert("end", "8. Cold-Formed Steel Framing\n", "emphasis")
            text_widget.insert("end", "   • Studs: 362S162 to 1200S200\n")
            text_widget.insert("end", "   • Tracks: 362T125 to 1200T200\n")
            text_widget.insert("end", "   • Gauges: 12 to 25\n")
            text_widget.insert("end", "   • Custom lengths\n")
            text_widget.insert("end", "   • Count: 200+ configurations\n\n")
            
            text_widget.insert("end", "9. Rebar\n", "emphasis")
            text_widget.insert("end", "   • Sizes: #3 through #18 (US)\n")
            text_widget.insert("end", "   • Grades: 40, 60, 75, 80\n")
            text_widget.insert("end", "   • Straight bars and bent shapes\n")
            text_widget.insert("end", "   • Count: 100+ configurations\n\n")
            
            text_widget.insert("end", "10. Sheet Steel\n", "emphasis")
            text_widget.insert("end", "   • Gauges: 10 to 28\n")
            text_widget.insert("end", "   • Custom width and length\n")
            text_widget.insert("end", "   • Flat sheets\n\n")
            
            text_widget.insert("end", "Total Available: 25,000+ parts\n", "emphasis")
